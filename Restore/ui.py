...
class create_widgets(QWidget):
    ...
    def create_grid_layout(self):
        ...
        grid = QGridLayout()
        self.setLayout(grid)
        grid.addWidget(self.location_selector(), 0, 0)
        grid.addWidget(self.cb_create_new_dirs(), 1, 0)
        grid.addWidget(self.cb_overwrite_existing(), 2, 0)
        grid.addWidget(self.entry_decryption_password(), 3, 0)
        grid.addWidget(self.start_restore_button(), 4, 0)
        ...
        def restore_dir_dialog():
            try:
                ...
                try:
                    ...
                    print("No config_file found. Backup might be corrupt")
            except:
                print("Unknown directory, please try again")
    ...
    def entry_decryption_password(self):
        ...
        self.decryption_password.setPlaceholderText("Password")
